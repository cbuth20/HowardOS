      ...
      <div className="p-3 border-b border-neutral-border">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-2 text-sm rounded-md border border-neutral-border bg-white text-text-primary focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary"
          />
        </div>
      </div>
